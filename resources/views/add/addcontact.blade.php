            ...
            <div class="row">
                    ...
                    <form action="{{ route('contact.add') }}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 mt-3">
                                ...
                                <textarea placeholder="Add 'None' if there is no note" class="form-control" name="notes" id="notes" cols="30"
                                    rows="5"></textarea>
                            </div>
                        </div>
                ...
                <div class="col-xl-5">
                    <div class="text-center">
                        <a href="mycontacts" class="btn btn-sm btn-danger mt-2 mb-4">My contacts</a>
                    </div>
                    <form action="{{ route('contacts.search') }}" method="get" class="">
                        <input type="text" name="search" class="form-control" required>
                        <input type="submit" name="search-btn" class="btn btn-info mt-2 btn-block" value="Search">
                    </form>
                </div>
            </div>
        </div>
